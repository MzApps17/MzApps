...
export default function ProductDetail(){
  ...
  const goToSellerProfile = ()=>{ if(currentUser && sellerUid && currentUser.uid === sellerUid) router.push("/account"); else if(sellerUid) router.push(`/seller/${sellerUid}`); };
